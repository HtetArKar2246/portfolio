      ...
      <div className="flex flex-col lg:flex-row text-center items-center p-3 w-full md:w-2/3 mx-auto">
        ...
        <div className="text-left mt-6 leading-5 lg:mt-0 lg:w-3/4 px-4 md:px-10">
          <p className="text-foreground2 font-medium text-lg sm:text-xl text-justify">
            I’m a passionate Software Engineering student with practical
            experience in web development, Python, and problem-solving. In
            addition to my studies, I have a strong foundation in some
            programming languages and frameworks. I enjoy working with teams,
            continuously learning, and adapting to new challenges. I’m looking
            for remote work opportunities that allow me to apply my skills while
            balancing my education.
          </p>
        </div>
